export default {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'string',
      description: "URL or anchor link for the hero button (e.g. '#contact-form').",
    },
      ...
      of: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              title: 'Service Title',
              type: 'string',
              description: 'Title of the service (e.g., Interior Painting).',
            },
            {
              name: 'description',
    ...
    },
    {
      ...
      type: 'text',
      description: "A paragraph describing Rich's background and approach.",
    },
    {
      name: 'aboutQuote',
      title: 'About Quote',
    ...
    },
    {
      ...
      type: 'text',
      description: "Paragraph for the 'Work Directly with Rich' section.",
    },
    ...
    },
    {
      ...
      type: 'text',
      description: 'Paragraph explaining how Rich partners with property managers.',
    },
  ],
  preview: {
    select: {
