...
export const metadata = {
  ...
  description:
    "Commission custom fine art from Rich Bennett, an academically-trained fine artist in Evansville. Portraits, landscapes, and unique artworks tailored to your vision.",
  keywords: [
